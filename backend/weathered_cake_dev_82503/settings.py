"""
Django settings for weathered_cake_dev_82503 project.
...
ROOT_URLCONF = 'weathered_cake_dev_82503.urls'
...
WSGI_APPLICATION = 'weathered_cake_dev_82503.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "weathered_cake_dev_82503 API",
    "DESCRIPTION": "API documentation for weathered_cake_dev_82503 App",
    "VERSION": "v1",
}
